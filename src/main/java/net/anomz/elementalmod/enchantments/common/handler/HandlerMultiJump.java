...
import net.anomz.elementalmod.enchantments.common.network.packet.PacketMultiJumpDo;
import net.anomz.elementalmod.enchantments.common.network.packet.PacketMultiJumpSync;
...
import static net.anomz.elementalmod.enchantments.common.registries.ModEnchants.MULTI_JUMP;
...
public class HandlerMultiJump {
    ...
    private static boolean allowJump(PlayerEntity player) {
        ...
        boolean performingAction = player.isOnGround() || player.isBeingRidden() || player.abilities.isFlying || player.abilities.allowFlying;
